...
public class DigitalClock extends RelativeLayout {
    ...
    private static final String SYSTEM_FONT_TIME_BACKGROUND = SYSTEM + "Roboto-Light.ttf";
    private static final String SYSTEM_FONT_TIME_FOREGROUND = SYSTEM + "Roboto-Light.ttf";
    ...
    static class AmPm {
        ...
        AmPm(View parent, Typeface tf) {
            ...
            String[] ampm = {"am","pm"};//new DateFormatSymbols().getAmPmStrings();
            mAmString = ampm[0];
            mPmString = ampm[1];
        }
    ...
    protected void onFinishInflate() {
        ...
        mTimeDisplayBackground.setVisibility(View.GONE);
