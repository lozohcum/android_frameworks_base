...
public final class PreferenceScreen extends PreferenceGroup implements AdapterView.OnItemClickListener,
    ...
    private boolean mIsShenDu = false;
    ...
    protected ListAdapter onCreateRootAdapter() {
        if (mIsShenDu) {
            return new ShenDuPreferenceGroupAdapter(this,mIsLight);
        } else {
    ...
    public void bind(ListView listView) {
        ...
        if (mIsShenDu) {
           ...
           if(mIsLight){
        	   listView.setDivider(listView.getResources().getDrawable(com.android.internal.R.drawable.listview_divi_line_light));
           }else{
        	   listView.setDivider(listView.getResources().getDrawable(com.android.internal.R.drawable.listview_divi_line_dark));
           }
           listView.setDividerHeight(listView.getResources().getDimensionPixelSize(com.android.internal.R.dimen.shendu_listview_divider_height));
           listView.setFooterDividersEnabled(false);
           boolean flag = listView.getAdapter().getItem(0) instanceof PreferenceCategory;
           listView.setPadding(listView.getResources().getDimensionPixelSize(com.android.internal.R.dimen.preference_fragment_padding_side), 
		        flag ? 0 : listView.getResources().getDimensionPixelSize(com.android.internal.R.dimen.shendu_listitem_padding),
    ...
    /** @hide*/
    public void setIsShenDu(boolean flag) {
    	setIsShenDu(flag,false);
	}
	
    /** @hide*/
	public void setIsShenDu(boolean flag, boolean isLight) {
        mIsShenDu = flag;
		mIsLight = isLight;
	} 
}
