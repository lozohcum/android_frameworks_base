...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        */
        ...
        /**
         * Sets the lockscreen head sculpture style
         * @hide
         */
        public static final String LOCKSCREEN_HEADSCULPTURE = "lockscreen_head_sculpture";
         ...
         * @hide
         */
        public static final String ADVANCE_SETTINGS_ENABLED = "advance_settings_enabled";
		...
		*/
        ...
        public static final String UI_FORCE_OVERFLOW_BUTTON = "ui_force_overflow_button";
         ...
         /**
          * Button backlight switch
          * add by shendu, liukai
          * @hide
          */
         public static final String BUTTON_BACKLIGHT_SWITCH = "button_backlight_switch";
          ...
          * @hide
          */
         public static final String APP_LIMIT_ENABLE = "app_limit_enable";

		/**
          * Limit password
          * @hide
          */
         public static final String APP_LIMIT_PASSWORD = "app_limit_password";

		/**
		  * Limit password sytle
		  * @hide
		  */
		 public static final String APP_LIMIT_PASSWORD_STYLE = "app_limit_password_styel";

		/**
		  * Limit list value
		  * @hide
		  */
		 public static final String APP_LIMIT_LIST = "app_limit_list";
