...
public class AppSecurityPermissions  implements View.OnClickListener {
    ...
    public View getPermissionsView() {
        ...
        mShowMaxIcon = mContext.getResources().getDrawable(R.drawable.expander_close_holo_light);
        mShowMinIcon = mContext.getResources().getDrawable(R.drawable.expander_open_holo_light);
