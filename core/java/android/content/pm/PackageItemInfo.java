...
public class PackageItemInfo {
    ...
    /******************************************************************/
    public Drawable loadShenduIcon(PackageManager pm) {
        if (icon != 0) {
            /******************************************************************/
        	Drawable dr = null;
            /**add 2012.08.28 by liuyongsheng*/
           if(this instanceof ActivityInfo){//1). if current this is activity load activityname.png
                dr = pm.shenduGetDrawable(name,packageName, icon, getApplicationInfo());
            }
           /**add 2012.08.28 by liuyongsheng*/
            else if(this instanceof ApplicationInfo){//2). if current this is application load packagename.png
                dr = pm.shenduGetDrawable(null,packageName, icon, getApplicationInfo());
            }
            //3). if Above Operation get drawable is null
           /********************************************************************/ 
           if(dr==null){
        ...
        return loadShenduDefaultIcon(pm);
    }
     ...
     * add ////////////////////////liuyongsheng
     */
    protected Drawable loadShenduDefaultIcon(PackageManager pm) {
