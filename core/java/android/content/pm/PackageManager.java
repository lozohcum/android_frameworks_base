...
public abstract class PackageManager {
	 ...
	 * @hide
	 */
    public abstract Drawable shenduGetDrawable(String activityName,String packageName, int resid,
            ApplicationInfo appInfo);
    /***********************************************************************/
    /**
	...
	* <p>
	* NOTE: If the package has a shared uid then the revoked permissions for that uid will be returned.
	...
	* <p>
	* NOTE: If the package has a shared uid then this method will revoke the permissions for that shared uid.
	*
	* @param packageName Name of the package which revoked permissions are needed
	* @hide
	*/
