        ...
        private void updateUsbNotification() {
            ...
            if (id != mUsbNotificationId) {
                ...
                if (id != 0) {
                    ...
                    /** Show the activity when usb connect
                     *  Add by ShenDu, Zhao in Dec 7th,2012.
                     */
                    Intent usbIntent = new Intent();
                    usbIntent.setComponent(new ComponentName("com.android.settings",
                                                   "com.android.settings.UsbPopUp"));
                    usbIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    usbIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    usbIntent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
