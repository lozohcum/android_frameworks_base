...
public class SignalStrength implements Parcelable {
    ...
    public int getAsuLevel() {
        ...
        if (isGsm) {
            ...
            if (evdoAsuLevel == 0) {
                ...
                asuLevel = cdmaAsuLevel < evdoAsuLevel ? evdoAsuLevel : cdmaAsuLevel;
            }
        }
        ...
        if(isGsm()) {
            if ((mLteSignalStrength == -1)
                ...
                dBm = (evdoDbm == -120) ? cdmaDbm : ((cdmaDbm == -120) ? evdoDbm
                    : (cdmaDbm < evdoDbm ? evdoDbm : cdmaDbm));;
        }
    ...
    public int getCdmaLevel() {
        ...
        if ("china".equals(CdmaFactory)) 
                level = (levelDbm < levelEcio) ? levelEcio : levelDbm;
        else
    ...
    public int getCdmaAsuLevel() {
        ...
        String CdmaFactory = SystemProperties.get("ro.cdma.factory");
        if ("china".equals(CdmaFactory)) 
                level = (cdmaAsuLevel < ecioAsuLevel) ? ecioAsuLevel : cdmaAsuLevel;
        else
                level = (cdmaAsuLevel < ecioAsuLevel) ? cdmaAsuLevel : ecioAsuLevel;
    ...
    public int getEvdoLevel() {
        ...
        String CdmaFactory = SystemProperties.get("ro.cdma.factory");
        if ("china".equals(CdmaFactory)) 
                level = (levelEvdoDbm < levelEvdoSnr) ? levelEvdoSnr : levelEvdoDbm;
        else
