...
public interface Phone {
    ...
    /**
     *Register for notification when CDMA call connection
     */
    void registerForCallLineControl(Handler h, int what, Object obj);
    void unregisterForCallLineControl(Handler h);
