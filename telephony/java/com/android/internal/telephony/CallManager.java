...
public final class CallManager {
    ...
    private static final int EVENT_CALL_LINE_CONTROL_INFO = 120;
	...
	protected final RegistrantList callLineControlInfoRegistrants = new RegistrantList();
    ...
    private void registerForPhoneStates(Phone phone) {
        ...
        if (phone.getPhoneType() == Phone.PHONE_TYPE_CDMA ){
            ...
            phone.registerForCallLineControl(mHandler, EVENT_CALL_LINE_CONTROL_INFO, null);
    ...
    private void unregisterForPhoneStates(Phone phone) {
        ...
        if (phone.getPhoneType() == Phone.PHONE_TYPE_CDMA ){
            ...
            phone.unregisterForCallLineControl(mHandler);
     ...
     *
     */
	public void registerForCallLineControl(Handler h,int what, Object obj) {
		callLineControlInfoRegistrants.addUnique(h,what,obj);
	}
	
	public void unregisterForCallLineControl(Handler h){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case EVENT_CALL_LINE_CONTROL_INFO:
                	if (VDBG) Log.d(LOG_TAG, " handleMessage (EVENT_CALL_LINE_CONTROL_INFO)");
                	callLineControlInfoRegistrants.notifyRegistrants((AsyncResult) msg.obj);
                	break;
            }
        }
    };
