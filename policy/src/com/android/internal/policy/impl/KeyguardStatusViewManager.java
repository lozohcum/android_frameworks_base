...
class KeyguardStatusViewManager implements OnClickListener {
    ...
    private ExtStatusChange mExtStatusChange = null;
    ...
    private static final Typeface sDateFont;
    static{
    	sDateFont = Typeface.createFromFile(SYSTEM_FONT_DATE);
    }
    ...
    public KeyguardStatusViewManager(View view, KeyguardUpdateMonitor updateMonitor,
        ...
        mContainer = view;
        mDateFormatString = getContext().getString(R.string.abbrev_wday_month_day);
    ...
    private void setWeatherData(WeatherInfo w) {
        ...
        if (mWeatherPanel != null) {
            ...
            if (mWeatherTempsPanel != null && mWeatherTemp != null && mWeatherLowHigh != null) {
                ...
                mWeatherTempsPanel.setVisibility((mTransportView.getVisibility()==View.VISIBLE)?View.GONE:View.VISIBLE);
            }

            // Show the Weather panel view
            mWeatherPanel.setVisibility((mTransportView.getVisibility()==View.VISIBLE)?View.GONE:View.VISIBLE);
        }
    }
    ...
    void resetStatusInfo() {
        ...
        //如果为下拉锁屏，就不显示充电信息 add liuyongsheng
        if(findViewById(R.id.unlock_widget) instanceof RotarySelector){
        	mShowingBatteryInfo = false;
        };
        mPluggedIn = mUpdateMonitor.isDevicePluggedIn();
        mBatteryLevel = mUpdateMonitor.getBatteryLevel();
        boolean holder = (mExtStatusChange==null ?
            			false : mExtStatusChange.onExtStatusChange(ExtStatusChange.BATTERY,mShowingBatteryInfo,mPluggedIn,mBatteryLevel));
            if(holder)	
            	mShowingBatteryInfo = false;
    ...
    private void updateClockAlign() {
        ...
        setSpecificMargins(mDigitalClock, leftMargin, -1, rightMargin, 0);
    ...
    private InfoCallbackImpl mInfoCallback = new InfoCallbackImpl() {
        ...
        public void onRefreshBatteryInfo(boolean showBatteryInfo, boolean pluggedIn,
            ...
            boolean holder = (mExtStatusChange==null ?
            			false : mExtStatusChange.onExtStatusChange(ExtStatusChange.BATTERY,showBatteryInfo,pluggedIn,batteryLevel));
            if(holder)	
            	mShowingBatteryInfo = false;
            final MutableInt tmpIcon = new MutableInt(0);
    ...
    /////////////////////////////////////lockview interface/////////////////////////////////////////
    public void setExtStatusChange(ExtStatusChange mExtStatusChange){
    	this.mExtStatusChange = mExtStatusChange;
    }
    
    public interface ExtStatusChange {
    	final int BATTERY 	= 0;
    	final int MUSIC		= 1;
    	// 更新状态信息
