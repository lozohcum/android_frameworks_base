...
public class TransparencyManager {
    ...
    private void doTransparentUpdate() {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                mIsPhoneShowing = isPhoneShowing();
                return null;
            }
    ...
    private boolean isPhoneShowing() {
        try {
            ActivityManager am = (ActivityManager) mContext.getSystemService(Context.ACTIVITY_SERVICE);
            final List<ActivityManager.RecentTaskInfo> recentTasks = am
                    .getRecentTasks(
            ...
            if (recentTasks.size() > 0) {
                ...
                if (isCurrentPhoneActivity(intent.getComponent(), null)) {
                    return true;
                }
            }
        } catch(Exception ignore) {
    ...
    private boolean isCurrentPhoneActivity(ComponentName component, ActivityInfo homeInfo) {
        return component.getPackageName().equals("com.android.phone");
    }
