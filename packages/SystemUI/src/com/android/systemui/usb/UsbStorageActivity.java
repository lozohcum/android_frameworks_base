...
public class UsbStorageActivity extends Activity
    ...
    private static final int USB_MTP = 0;
    private static final int USB_PTP = 1;
    private static final int USB_MASS_STORAGE = 2;
