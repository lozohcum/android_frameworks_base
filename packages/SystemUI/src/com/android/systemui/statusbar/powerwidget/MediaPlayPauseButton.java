...
public class MediaPlayPauseButton extends MediaKeyEventButton {
    ...
    protected void updateState(Context context) {
        ...
        if (isMusicActive(context)) {
            ...
            setText(context.getResources().getString(R.string.powerwidget_pause), TEXT_COLOR_ENABLE);
        } else {
            mIcon = R.drawable.stat_media_play;
            setText(context.getResources().getString(R.string.powerwidget_play), TEXT_COLOR_ENABLE);
        }
    }
