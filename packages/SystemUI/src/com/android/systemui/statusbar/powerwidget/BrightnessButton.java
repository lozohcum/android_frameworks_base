...
public class BrightnessButton extends PowerButton {
    ...
    protected void updateState(Context context) {
        ...
        setText(context.getResources().getString(R.string.powerwidget_brightness));
    }
        ...
        if (!mAutoBrightness) {
            ...
            if (mAutoBrightnessSupported) {
                ...
                try {
                    ...
                    if (power != null) {
                        power.setBacklightBrightness(BrightnessSeekBar.currentBrightness);
                    }
