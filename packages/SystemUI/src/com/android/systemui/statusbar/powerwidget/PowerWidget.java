...
public class PowerWidget extends FrameLayout {
    ...
    private FrameLayout.LayoutParams WIDGET_LAYOUT_PARAMS;
    ...
    //Max count of the bottom widget
    private static final int MAX_BOTTOM_COUNT = 5;
    ...
    public void setupWidget() {
        ...
        for (String button : buttons.split("\\|")) {
            ...
            if (flag) {
                if (loadButton(button) & mButtonNames.toArray().length < MAX_BOTTOM_COUNT) {
...
//        filter.addAction(Settings.SETTINGS_CHANGED);
    ...
    private void recreateButtonLayout() {
        ...
        mButtonLayout.setBackgroundResource(R.drawable.power_widget_bottom_bg);
        
        final float scale = mContext.getResources().getDisplayMetrics().density;
        final int lineHeight = (int) (86 * scale + 0.5f);
        WIDGET_LAYOUT_PARAMS = new FrameLayout.LayoutParams(
