...
import android.util.shendu.Lunar;
...
public final class DateView extends LinearLayout implements OnClickListener, OnTouchListener {
    ...
    public DateView(Context context, AttributeSet attrs) {
        ...
        mDoW.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, 0, 1.0f));
        mDoW.setSingleLine();
        mDoW.setTextColor(context.getResources().getColor(R.color.dateview_text_color));
//        mDoW.setTextAppearance(context, R.style.TextAppearance_StatusBar_Expanded_Date);
        ...
        mDate.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, 0, 1.0f));
        mDate.setSingleLine();
        mDate.setTextColor(context.getResources().getColor(R.color.dateview_text_color));
//        mDate.setTextAppearance(context, R.style.TextAppearance_StatusBar_Expanded_Date);
    ...
    private final void updateClock() {
        ...
        Date now = new Date();
        String month[] = mContext.getResources().getStringArray(R.array.month);
        ...
        String w = weekdays[cal.get(Calendar.DAY_OF_WEEK) - 1];
        int d = cal.get(Calendar.DAY_OF_MONTH);
        String m = month[cal.get(Calendar.MONTH)];

        String dat = m + d
        		+ mContext.getResources().getString(R.string.day)
        		+ w;
        Lunar lunar = new Lunar(Calendar.getInstance(), mContext);

        mDoW.setText(lunar.toString(true));
        mDate.setText(dat);
    }
